...
# Fazer a leitura das valores necessários para execução das
# funcionalidades previstas na lista
email = input('Informe o email de destino da média TTL: ')
# ...
quantidade_maxima_pacotes = 67 # input
somaTTL = 0
...
while True:
    ...
    somaTTL = somaTTL + float(ttl)
    if(i == quantidade_maxima_pacotes):
        print(quantidade_maxima_pacotes)
        # enviar a media TTL, que é basicamente somaTTL/quantidade_maxima_pacotes
        # 1. enviar via socket cliente
        # 2. enviar via email
